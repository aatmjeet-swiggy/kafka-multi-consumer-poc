...
func init() {
	...
	flag.StringVar(&group, "group", "cg-id", "Kafka consumer group definition")
	flag.StringVar(&version, "version", sarama.DefaultVersion.String(), "Kafka cluster version")
	flag.StringVar(&topics, "topics", "example-topic,example-topic-1", "Kafka topics to be consumed, as a comma separated list")
